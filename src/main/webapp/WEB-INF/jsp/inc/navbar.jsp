    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li><s:url action="aboutus" var="aboutusInputLink" /><a href="${aboutusInputLink}"><s:text name="menu.aboutus" /></a></li>
            </ul>
            <form class="navbar-form navbar-right" action="Desconectar.action">
                ...
                <s:else><button type="submit" class="btn btn-success"><s:text name="form.closesession" /><s:property value="#usuario" /></button></s:else>
            </form>
        </div><!-- /.nav-collapse -->
    </div><!-- /.container -->
</nav><!-- /.navbar -->